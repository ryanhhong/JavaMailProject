...
public class RecieveMail2 {
				...
				for(int i = 0;i<messages.length;i++)
				{
					...
					if(message.getSubject().equals("NEW EMPLOYEE") ||message.getSubject().equals("New Employee"))
					{
			          ...
			          //String Name = s.substring(0, s.indexOf("<"));
			            ...
			            String employeeNumber = en.substring(s.indexOf("EMPLOYEE: ")+10, en.indexOf("EMPLOYEE: ")+17);
			           ...
			           // System.out.println(employeeNumber);
				        ...
				        String passwords = "Hiworld1";						//password
				        ...
				        String Estimated = ("Your request has been sent to ryan.hong@sjsu.edu on: "+ theDate+".");
				        String messagess = Estimated;
				        String messagesss = " The Estimated delivery date is: "+newDate+"." ;
				        String Messages1 = "Employee notified that request has been sent on: " +theDate;
				        String Messages2 = "Employee has been notified with estimated delivery day: "+newDate;
				        // attachments
				        ...
				        sendEmailWithAttachments(host, port, mailFrom, passwords, "ryan.hong@sjsu.edu",
					...
					if(message.getSubject().equals("NEW EMPLOYEE LAPTOP REQUEST") ||message.getSubject().equals("New Employee Laptop Request"))
							{
						Message msg = emailFolder.getMessage(i+1);
			            Multipart mp = (Multipart) msg.getContent();
			            BodyPart bp = mp.getBodyPart(0);
			            ...
			            String deliveryDate = dd.substring(s.indexOf("DELIVERY DATE: ")+32, dd.indexOf("DELIVERY DATE: ")+25);
	...
	public static void main(String args[]) {
		AutomatedMail("zkm7184@gmail.com", "Hiworld1");
